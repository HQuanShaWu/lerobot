...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        return GrootPolicy
    elif name == "efficientvla":
        from lerobot.policies.efficientvla.modeling_efficientvla import EfficientVLAPolicy
        
        return EfficientVLAPolicy
    else:
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "efficientvla": 
        return EfficientVLAConfig(**kwargs)
    else:
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, EfficientVLAConfig):
        from lerobot.policies.efficientvla.processor_efficientvla import make_efficientvla_pre_post_processors

        processors = make_efficientvla_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
