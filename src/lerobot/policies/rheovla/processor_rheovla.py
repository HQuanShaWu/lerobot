...
def make_rheovla_pre_post_processors(
    config: RheoVLAConfig, dataset_stats: dict[str, dict[str, torch.Tensor]] | None = None
) -> tuple[
    PolicyProcessorPipeline[dict[str, Any], dict[str, Any]],
    PolicyProcessorPipeline[PolicyAction, PolicyAction],
]:
    """Create preprocessor and postprocessor for RheoVLA policy.
    ...
    Args:
        config: RheoVLA configuration containing data_config, embodiment_tag, etc.
...
@dataclass
@ProcessorStepRegistry.register(name="rheovla_pack_inputs_v3")
...
@dataclass
@ProcessorStepRegistry.register(name="rheovla_eagle_encode_v3")
...
@dataclass
@ProcessorStepRegistry.register(name="rheovla_eagle_collate_v3")
...
@dataclass
@ProcessorStepRegistry.register(name="rheovla_action_unpack_unnormalize_v1")
