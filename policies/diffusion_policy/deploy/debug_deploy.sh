...
DEPLOY_WS="/home/data/Project/Diffusion_Policy"
ORACLE_WS="/home/data/Project/Diffusion_Policy"
CAN_PORT="can0"
GRIPPER_PORT="/dev/ttyUSB0"
CAN_ACTIVATE_SCRIPT="$PIPER_WS/can_activate.sh"
PIPER_LOG="$DEPLOY_WS/piper.log"
DEPLOY_SCRIPT="$ORACLE_WS/debug_deploy.py"
CHECKPOINT="${CHECKPOINT:-/home/data/Project/Diffusion_Policy/checkpoints/crop_480_100k_step/100000/pretrained_model}"
